...
async def list_receipts(
    ...
    return await service.list_receipts(skip, limit, status, store_name, start_date, end_date, min_total, max_total)
...
async def add_receipt_item(
    ...
    return await service.add_item(receipt_id, item_in)
...
async def confirm_receipt(
    ...
    return await service.confirm_receipt(receipt_id)
